...
export default function TrainingFrequencyChart({ logs }: { logs: TrainingLog[] }) {
  ...
  return (
    <ResponsiveContainer width="100%" height={280}>
      <BarChart data={chartData} layout="vertical" margin={{ top: 8, right: 16, left: 8, bottom: 0 }}>
        ...
        <YAxis type="category" dataKey="name" width={100} tick={{ fontSize: 11, fill: "#10182B" }} axisLine={false} tickLine={false} />
